...
public abstract class GenericRequestTask extends AsyncTask<String, String, TaskOutput> {
    ...
    protected MainActivityforecastie activity;
    ...
    public GenericRequestTask(Context context, MainActivityforecastie activity, ProgressDialog progressDialog) {
    ...
    private String makeRequest(TaskOutput output, String response, String[] reqParams) {
        try {
            ...
            if (urlConnection.getResponseCode() == 200) {
                ...
                MainActivityforecastie.saveLastUpdateTime(PreferenceManager.getDefaultSharedPreferences(context));
