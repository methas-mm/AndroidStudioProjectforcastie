...
public class MainActivityforecastie extends BaseActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog( MainActivityforecastie.this);
    ...
    protected void onDestroy() {
        ...
        if (locationManager != null) {
            try {
                locationManager.removeUpdates( MainActivityforecastie.this);
    ...
    private void preloadUVIndex() {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences( MainActivityforecastie.this);
            ...
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                if (!result.isEmpty()) {
                    new FindCitiesByNameTask(getApplicationContext(),
                            MainActivityforecastie.this, progressDialog).execute("city", result);
                }
            }
        });
    ...
    private void saveLocation(String result) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences( MainActivityforecastie.this);
...
//        }
    ...
    private ParseResult parseTodayJson(String result) {
        try {
            ...
            PreferenceManager.getDefaultSharedPreferences( MainActivityforecastie.this)
                    .edit()
    ...
    private void updateTodayWeatherUI() {
        ...
        linearLayoutTapForGraphs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent( MainActivityforecastie.this, GraphActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_map) {
            Intent intent = new Intent( MainActivityforecastie.this, MapActivity.class);
            startActivity(intent);
        }
    ...
    class TodayWeatherTask extends GenericRequestTask {
        public TodayWeatherTask(Context context, MainActivityforecastie activity, ProgressDialog progressDialog) {
    ...
    class LongTermWeatherTask extends GenericRequestTask {
        public LongTermWeatherTask(Context context, MainActivityforecastie activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
    ...
    class FindCitiesByNameTask extends GenericRequestTask {
        ...
        public FindCitiesByNameTask(Context context, MainActivityforecastie activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
...
//                saveLocation(reader.getString("id"));
    ...
    class ProvideCityNameTask extends GenericRequestTask {
        ...
        public ProvideCityNameTask(Context context, MainActivityforecastie activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
    ...
    class TodayUVITask extends GenericRequestTask {
        public TodayUVITask(Context context, MainActivityforecastie activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
